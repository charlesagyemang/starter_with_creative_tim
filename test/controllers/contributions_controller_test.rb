...
class ContributionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post contributions_url, params: { contribution: { amount: @contribution.amount, interest: @contribution.interest, period_end: @contribution.period_end, period_start: @contribution.period_start, principal: @contribution.principal, references: @contribution.references } }
    end
  ...
  test "should update contribution" do
    patch contribution_url(@contribution), params: { contribution: { amount: @contribution.amount, interest: @contribution.interest, period_end: @contribution.period_end, period_start: @contribution.period_start, principal: @contribution.principal, references: @contribution.references } }
