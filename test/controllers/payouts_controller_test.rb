...
class PayoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payout" do
    assert_difference('Payout.count') do
      post payouts_url, params: { payout: { amount: @payout.amount, contribution_id: @payout.contribution_id, date: @payout.date, investor_id: @payout.investor_id } }
    end
  ...
  test "should update payout" do
    patch payout_url(@payout), params: { payout: { amount: @payout.amount, contribution_id: @payout.contribution_id, date: @payout.date, investor_id: @payout.investor_id } }
