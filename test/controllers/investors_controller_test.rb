...
class InvestorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investor" do
    assert_difference('Investor.count') do
      post investors_url, params: { investor: { details: @investor.details, email: @investor.email, first_name: @investor.first_name, last_name: @investor.last_name, occupation: @investor.occupation, phone_number: @investor.phone_number, position: @investor.position } }
    end
  ...
  test "should update investor" do
    patch investor_url(@investor), params: { investor: { details: @investor.details, email: @investor.email, first_name: @investor.first_name, last_name: @investor.last_name, occupation: @investor.occupation, phone_number: @investor.phone_number, position: @investor.position } }
