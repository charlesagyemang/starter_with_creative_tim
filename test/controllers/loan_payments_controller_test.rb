...
class LoanPaymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create loan_payment" do
    assert_difference('LoanPayment.count') do
      post loan_payments_url, params: { loan_payment: { amount: @loan_payment.amount, loan_id: @loan_payment.loan_id, loaner_id: @loan_payment.loaner_id, mode: @loan_payment.mode, next_payment_date: @loan_payment.next_payment_date, status: @loan_payment.status } }
    end
  ...
  test "should update loan_payment" do
    patch loan_payment_url(@loan_payment), params: { loan_payment: { amount: @loan_payment.amount, loan_id: @loan_payment.loan_id, loaner_id: @loan_payment.loaner_id, mode: @loan_payment.mode, next_payment_date: @loan_payment.next_payment_date, status: @loan_payment.status } }
