...
class ContributionsTest < ApplicationSystemTestCase
  ...
  test "creating a Contribution" do
    ...
    fill_in "Interest", with: @contribution.interest
    fill_in "Period end", with: @contribution.period_end
    fill_in "Period start", with: @contribution.period_start
    fill_in "Principal", with: @contribution.principal
    fill_in "References", with: @contribution.references
